function openCart() {
  ...
  document.getElementById("gstLabel").innerHTML = `$${calculateTaxes(calculateSubtotal(cart), GST)}`;
  document.getElementById("qstLabel").innerHTML = `$${calculateTaxes(calculateSubtotal(cart), QST)}`;
  document.getElementById("deliveryLabel").innerHTML = `$${calculateTaxes(calculateSubtotal(cart), SHIPPING_RATE)}`;
  document.getElementById("totalLabel").innerHTML = `$${calculateTotal(calculateSubtotal(cart), calculateTaxes(calculateSubtotal(cart), GST), calculateTaxes(calculateSubtotal(cart), QST), calculateTaxes(calculateSubtotal(cart), SHIPPING_RATE))}`;
