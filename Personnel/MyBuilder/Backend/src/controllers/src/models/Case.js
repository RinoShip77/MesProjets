...
class Case extends Product {
  constructor(id, name, imageURL, productURL, price, manufacturer, quantityInStock, rating, type, powerSupply, sidePanel, frontPanelUSB, motherboardFormFactor, maximumVideoCardLength, dimensions) {
