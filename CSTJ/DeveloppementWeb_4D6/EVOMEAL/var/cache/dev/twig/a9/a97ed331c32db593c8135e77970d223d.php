...
class __TwigTemplate_230f4825ddc86ff52cacaf966df4d063 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("core/base.html.twig", "error/error.html.twig", 1);
...
\t\t<h3 class=\"text-danger mt-5 mb-3\">Vous vous êtes égarés.</h3>
\t\t<img src=\"";
        // line 6
        ...
        echo "\" alt=\"Error\" class=\"img-fluid w-25\">
\t\t<br>
\t\t<a href=\"";
        // line 8
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("catalog.route");
        echo "\" class=\"btn btn-dark mt-5 mb-3\">Retourner à l'accueil</a>
\t</div>
";
...
\t\t<h3 class=\"text-danger mt-5 mb-3\">Vous vous êtes égarés.</h3>
\t\t<img src=\"{{ asset('images/companiesLogos/myLogo.png') }}\" alt=\"Error\" class=\"img-fluid w-25\">
\t\t<br>
\t\t<a href=\"{{ path('catalog.route') }}\" class=\"btn btn-dark mt-5 mb-3\">Retourner à l'accueil</a>
\t</div>
{% endblock %}
", "error/error.html.twig", "C:\\Users\\olivi\\Documents\\GitHub\\travaux-pratiques-Olivier1875009\\templates\\error\\error.html.twig");
    }
}
