...
// //Avertisseur sonore
// const int buzzerPin = 5; //Avertisseur sonore sur ce branchement
...
// SoftwareSerial monserial(8, 7); //Pour établir la connection entre les Arduino sur ce port
...
// const String codeSystemeAlarme = "1 2 3 4"; //4203 //Correspond au code du système d'alarme
// bool validationCode = false; //Indique si le code entré sera valide

// //Pour la tempérture
// const float temperatureMax = 22; //Représente la température maximale
...
//   //Communication vers Arduino Mega
//   monserial.begin(115200); //Initialise la console pour l'autre arduino
...
//         //Fait vibrer la buzzer une première fois
//         digitalWrite(5, HIGH);
//         delay(delais);
//         digitalWrite(5, LOW);
//         delay(delais);

//         //Fait vibrer la buzzer une deuxième fois
//         digitalWrite(5, HIGH);
//         delay(delais);
//         digitalWrite(5, LOW);
//         delay(delais);
